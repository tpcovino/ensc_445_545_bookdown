...
Finally, discharge is calculated by multiplying V by the channel cross-sectional area, A (L^2^). This is particularly useful when estimating streamflow at bankfull depth or during a flood event when it isn’t safe to conduct direct measurements (i.e., wade across the stream to perform a velocity-area measurement).
