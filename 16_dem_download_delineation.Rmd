...
In this tutorial shows you how to download a DEM and delineate a watershed. You can use this code to produce a map of your study watershed for your project if that applies. 
...
# clip_dem_df <- as_data.frame(clip_dem, xy = TRUE)
