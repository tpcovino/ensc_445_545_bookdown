...
**Week 5 (Units 1 - 4)**: <br> 
- *Lecture (2/14)*: Term project overview and assign take home **Exam 1**. <br>
...
- *Exam 1 part II (2/16)*: In class work and Exam 1 resubmission.
...
**Week 7 (Unit 6)**: <br>
- *Lecture (2/28)*: Flow frequency analysis (high and low flows) <br>
- *Lab 5 (3/2)*: Flow frequency analysis <br>
...
*AND* [Definitions and characteristics of low flows](https://www.epa.gov/ceam/definition-and-characteristics-low-flows#1Q10){target="_blank"} in EPA Environmental Modeling Community of Practice

**Week 8 (Unit 6 contd)**: <br>
- *Lecture (3/7)*: Precipitation data acquisition and analysis <br>
- *Lab 6 (3/9)*: Precipitation analysis <br>
...
**Week 10 (Unit 7)**: <br> 
- *Lecture (3/21)*: Hydrologic processes, climate and water balance. Trend detection and analysis, non-parametric approaches.<br>
- *Lab 7 (3/23)*: Trend analysis <br>
...
**Week 11 (Unit 8)**: <br>
- *Lecture (3/28)*: Geospatial data in R <br>
- *Lab (3/30)*: Term project work session and assign **Exam 2**


**Week 12 (Units 5 - 8)**: <br>
- *Lecture (4/4)*: Geospatial hydrology in R <br>
- *Lab (4/6)*: In class work and Exam 1 resubmission. <br> 
- *Reading*: [Geocomputation with R](https://geocompr.robinlovelace.net/intro.html){target="_blank"}
*AND* [Geospatial analysis in R](https://pjbartlein.github.io/REarthSysSci/geospatial.html){target="_blank"}

**Week 13 (Unit 9)**: <br>
- *Lecture (4/11)*: Watershed delineation in R <br>
- *Lab (4/13)*: Term project update presentations

**Week 14 (Unit 10)**: <br>
- *Lecture (4/18)*: Hydrological modeling part 1 <br>
...
- *Lecture (4/25)*: Hydrological modeling part 2 <br>
- *Lab (4/27)*: Lab or term project work session (TBD)

**Week 16**: Term project presentations (5/2 and 5/4)

**Week 17 (finals week)**: Final exam 5/9 10 - 11:50 AM (Units 1 - 10)
