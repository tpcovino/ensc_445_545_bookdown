...
met_data_an <- met_data_adj %>% 
  group_by(wtr_yr) %>% 
  reframe(tot_p = sum(prcp, na.rm = TRUE), # Can also use reframe here instead of summarize. Reframe is a more generalizable form of summarize. 
