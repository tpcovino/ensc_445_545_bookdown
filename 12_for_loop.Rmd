# For loops (and other skills)

[Link to repo](https://github.com/tpcovino/skills){target="_blank"}
...
# You can also tell R to load (read_csv) all data files in your folder (e.g., "data/bunch_of_files.csv"). If interested try to get that to work before seeing the end of this Rmd. 
```
