...
You can find the repo for this activity [here](https://github.com/tpcovino/07_hydro_stats#){target="_blank"}
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/YjuOfu_1rhs?si=-PfiucdqrExHxPr2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>{target="_blank"}
...
## Question: Discuss with partner. We will report as group. 
