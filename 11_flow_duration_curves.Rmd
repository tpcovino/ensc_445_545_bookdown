...
# Flow Duration Curves (6 pts, peer grading)
...
## Module Question 1 (1 pts): Describe the differences in flow regime you see between the three periods of 1960-1980, 1980-2000, and 2000-2020.
...
## Module Question 2 (1 pts): What are the advantages/disadvantages of the flow duration curves vs. boxplots?
...
## Module Summary Assignment: Examining flow regime change at the Grand Canyon (4 pts)
...
1. Provide your answers to module questions 1 & 2 (2 pts)

2. Create a line plot of discharge and flow duration curves to examine the differences in discharge for the periods: 1905 - 1936, 1937 - 1965. Use patchwork to place the figures side-by-side. (2 pts)

2. Describe what the FDCs for the two periods tell you about the flows in the river. Be specific and quantitative in your description. (2 pts)
